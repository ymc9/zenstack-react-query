...
export function useCreateManyAccount(options?: Omit<UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.AccountCreateManyArgs>, 'mutationFn'>, invalidateQueries: boolean = true) {
    const { endpoint } = useContext(RequestHandlerContext);
    const _mutation =
        request.postMutation<Prisma.AccountCreateManyArgs, Prisma.BatchPayload>('Account', `${endpoint}/account/createMany`, options, invalidateQueries)
        ;
    const mutation = {
        ..._mutation,
        async mutateAsync<T extends Prisma.AccountCreateManyArgs>(
            args: Prisma.SelectSubset<T, Prisma.AccountCreateManyArgs>,
            options?: Omit<UseMutationOptions<Prisma.BatchPayload, unknown, Prisma.SelectSubset<T, Prisma.AccountCreateManyArgs>>, 'mutationFn'>
        ) {
            return (await _mutation.mutateAsync(
                args,
                options as any
